...
<body>
  ...
  <div class="main">
    <div class="left container-custom row">
      <div class="col-12 col-md-6 order-2 order-md-1 form-section">
      ...
      <div class="right col-12 col-md-6 d-flex align-items-center justify-content-center order-1 order-md-2">
